...
/* harmony import */ var _util_render__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./util/render */ "./src/util/render.js");
...
const renderEvent = (eventsListElement, eventElement) => {
  const eventComponent = new _view_event__WEBPACK_IMPORTED_MODULE_7__["default"](eventElement);
  const eventEditComponent = new _view_edit_event__WEBPACK_IMPORTED_MODULE_6__["default"](eventElement);

  eventComponent.setClickEditHandler(() => {
    Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["replace"])(eventEditComponent, eventComponent);
    document.addEventListener(`keydown`, onEscKeyDown);
  });

  const closeCard = () => {
    Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["replace"])(eventComponent, eventEditComponent);
  ...
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(eventsListElement, eventComponent, _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
};


const renderTripBoard = () => {
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripMainElement, new _view_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"](events), _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN);
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripControlsElement, new _view_site_menu__WEBPACK_IMPORTED_MODULE_1__["default"](), _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN);
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripControlsElement, new _view_trip_filters__WEBPACK_IMPORTED_MODULE_2__["default"](), _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripEventsElement, new _view_trip_sorting__WEBPACK_IMPORTED_MODULE_5__["default"](), _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].AFTERBEGIN);
  Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripEventsElement, eventsListComponent, _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  ...
  if (events.length) {
    ...
    Object(_util_render__WEBPACK_IMPORTED_MODULE_9__["render"])(tripEventsElement, new _view_empty_list__WEBPACK_IMPORTED_MODULE_3__["default"](), _const__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
...
/*!***************************!*\
  !*** ./src/util/event.js ***!
  \***************************/
/*! exports provided: humaneEventDate, humaneEventTime, humaneEditEventTime, createPrepositions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createEditEventTemplate = (event = {}) => {
  ...
  const createEventTypeItems = () => {
    return `
    ${_const__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"].map(({type, name, image, id}) => `
              ...
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_2__["humaneEditEventTime"])(eventStart)}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_2__["humaneEditEventTime"])(eventEnd)}">
                  </div>
