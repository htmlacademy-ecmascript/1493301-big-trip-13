...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: TRANSFER_EVENTS, SortTypes, RenderPosition, FilterTypes, MenuTabs */
...
/* harmony import */ var _mock_event__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/event */ "./src/mock/event.js");
...
const events = new Array(EVENTS_AMOUNT).fill().map(_mock_event__WEBPACK_IMPORTED_MODULE_7__["generateEvent"]);
...
const eventsListComponent = new _view_list__WEBPACK_IMPORTED_MODULE_3__["default"]();

const renderEvent = (eventsListElement, eventElement) => {
  const eventComponent = new _view_event__WEBPACK_IMPORTED_MODULE_6__["default"](eventElement).getElement();
  const eventEditComponent = new _view_edit_event__WEBPACK_IMPORTED_MODULE_5__["default"](eventElement).getElement();
  ...
  Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(eventsListElement, eventComponent, _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
};

Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(tripMainElement, new _view_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"](events).getElement(), _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);
Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(tripControlsElement, new _view_site_menu__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement(), _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);
Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(tripControlsElement, new _view_trip_filters__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(tripEventsElement, new _view_trip_sorting__WEBPACK_IMPORTED_MODULE_4__["default"]().getElement(), _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);
Object(_util__WEBPACK_IMPORTED_MODULE_8__["render"])(tripEventsElement, eventsListComponent.getElement(), _const__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
...
const generateEndDate = (eventStart) => {
  return dayjs__WEBPACK_IMPORTED_MODULE_1___default()(eventStart).add(Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 48), `hours`).add(Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 60), `minutes`).toDate();
};
...
const generateStartDate = () => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_1___default()().add(daysGap, `day`).add(hourGap, `hour`).add(minGap, `minute`).toDate();
};
...
const EVENT_OFFERS = [
  {
    ...
    isChecked: Boolean(Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 2)),
  },
  {
...
const generateOffers = () => {
  let offers = [];
  const isOffers = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, OFFERS_AMOUNT);
  if (isOffers) {
    offers = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomArray"])(EVENT_OFFERS, OFFERS_AMOUNT)
        .map(function (offer) {
...
const generateEvent = () => {
  ...
  const travelDuration = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(eventEnd).diff(eventStart, `minutes`);
  const city = generateCities();
  const eventType = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getRandomElement"])(Object.keys(EVENT_TYPES));
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: createElement, getRandomInteger, capitalize, humaneEventDate, humaneEventTime, humaneEditEventTime, getRandomElement, getRandomArray, createPrepositions, render, renderTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
                ...
                <header class="event__header">
                  <div class="event__type-wrapper">
                    ...
                    <label class="event__label  event__type-output" for="event-destination-1">
                      ${Object(_util__WEBPACK_IMPORTED_MODULE_0__["capitalize"])(eventType)} ${Object(_util__WEBPACK_IMPORTED_MODULE_0__["createPrepositions"])(eventType)}
                    </label>
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_util__WEBPACK_IMPORTED_MODULE_0__["humaneEditEventTime"])(eventStart)}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_util__WEBPACK_IMPORTED_MODULE_0__["humaneEditEventTime"])(eventEnd)}">
                  </div>
