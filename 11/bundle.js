...
/*!***************************!*\
  !*** ./src/mock/event.js ***!
  \***************************/
/*! exports provided: generateDescription, generatePhotos, generateOffers, generateEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _util_const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/const */ "./src/util/const.js");
...
const generateCities = () => {
  const randomIndex = Object(_util_global__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _util_const__WEBPACK_IMPORTED_MODULE_2__["CITIES"].length - 1);

  return _util_const__WEBPACK_IMPORTED_MODULE_2__["CITIES"][randomIndex];
};

const generateEndDate = (eventStart) => {
  return dayjs__WEBPACK_IMPORTED_MODULE_3___default()(eventStart).add(Object(_util_global__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, 48), `hours`).add(Object(_util_global__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, 60), `minutes`).toDate();
};
...
const generateStartDate = () => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_3___default()().add(daysGap, `day`).add(hourGap, `hour`).add(minGap, `minute`).toDate();
};
...
const generateEvent = () => {
  ...
  const travelDuration = dayjs__WEBPACK_IMPORTED_MODULE_3___default()(eventEnd).diff(eventStart, `minutes`);
...
/* harmony import */ var _util_const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/const */ "./src/util/const.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _util_global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/global */ "./src/util/global.js");
/* harmony import */ var _util_event__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util/event */ "./src/util/event.js");
/* harmony import */ var _mock_event__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mock/event */ "./src/mock/event.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _smart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./smart */ "./src/view/smart.js");
...
const createEventTypeItems = () => {
  ...
  ${_const__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"].map((type, id) => `
      <div class="event__type-item">
          <input id="event-type-${type}-${id}" class="event__type-input  visually-hidden" type="radio" name="event-type" value="${type}">
          <label class="event__type-label  event__type-label--${type}" for="event-type-${type}-${id}">${Object(_util_global__WEBPACK_IMPORTED_MODULE_2__["capitalize"])(type)}</label>
      </div>`).join(``)}
    `;
};
...
const createEditEventTemplate = (event = {}) => {
  ...
  const isSaveForbidden = !dayjs__WEBPACK_IMPORTED_MODULE_5___default()(eventEnd).isAfter(dayjs__WEBPACK_IMPORTED_MODULE_5___default()(eventStart).toDate());
                ...
                <header class="event__header">
                  <div class="event__type-wrapper">
                    ...
                    <label class="event__label  event__type-output" for="event-destination-${city}">
                      ${Object(_util_global__WEBPACK_IMPORTED_MODULE_2__["capitalize"])(eventType)}  ${Object(_util_event__WEBPACK_IMPORTED_MODULE_3__["createPrepositions"])(eventType)}
                    </label>
                    ...
                    <datalist id="destination-list-${id}">
                      ${_util_const__WEBPACK_IMPORTED_MODULE_0__["CITIES"].map((name) => `<option value="${name}"></option>`).join(``)}
                    </datalist>
                  </div>
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input event__input--time" id="event-start-time-1" type="text" name="event-start-time" data-time="start" value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_3__["humaneEditEventTime"])(eventStart)}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input event__input--time" id="event-end-time-1" type="text" name="event-end-time" data-time="end"  value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_3__["humaneEditEventTime"])(eventEnd)}">
                  </div>
...
class EditEventView extends _smart__WEBPACK_IMPORTED_MODULE_6__["default"] {
  constructor(event) {
    super();
  ...
  _setDatepicker() {
    ...
    this._datepicker = flatpickr__WEBPACK_IMPORTED_MODULE_7___default()(
  ...
  _cityInputHandler(evt) {
    ...
    if (!_util_const__WEBPACK_IMPORTED_MODULE_0__["CITIES"].includes(newCity)) {
    ...
    this.updateData({
      city: newCity,
      description: Object(_mock_event__WEBPACK_IMPORTED_MODULE_4__["generateDescription"])(),
      photos: Object(_mock_event__WEBPACK_IMPORTED_MODULE_4__["generatePhotos"])(),
    });
  }
  ...
  _eventTypeToggleHandler(evt) {
    ...
    const setUpNewTypes = (value) => {
      return _const__WEBPACK_IMPORTED_MODULE_1__["EVENT_TYPES"].find((type) => type === value);
    };
    const newType = setUpNewTypes(evt.target.value);
    const offers = Object(_mock_event__WEBPACK_IMPORTED_MODULE_4__["generateOffers"])();
