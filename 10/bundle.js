...
/*!***************************!*\
  !*** ./src/mock/event.js ***!
  \***************************/
/*! exports provided: CITIES, generateDescription, generatePhotos, generateOffers, generateEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _util_global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/global */ "./src/util/global.js");
/* harmony import */ var _smart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./smart */ "./src/view/smart.js");
                ...
                <header class="event__header">
                  <div class="event__type-wrapper">
                    ...
                    <label class="event__label  event__type-output" for="event-destination-${city}">
                      ${Object(_util_global__WEBPACK_IMPORTED_MODULE_2__["capitalize"])(eventType)}  ${Object(_util_event__WEBPACK_IMPORTED_MODULE_1__["createPrepositions"])(eventType)}
                    </label>
                    ...
                    <datalist id="destination-list-${id}">
                      ${_mock_event__WEBPACK_IMPORTED_MODULE_4__["CITIES"].map((name) => `<option value="${name}"></option>`).join(``)}
                    </datalist>
                  </div>
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-${id}" type="text" name="event-start-time" value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_1__["humaneEditEventTime"])(eventStart)}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-${id}" type="text" name="event-end-time" value="${Object(_util_event__WEBPACK_IMPORTED_MODULE_1__["humaneEditEventTime"])(eventEnd)}">
                  </div>
...
class EditEventView extends _smart__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(event) {
    super();
  ...
  _cityInputHandler(evt) {
    ...
    if (!_mock_event__WEBPACK_IMPORTED_MODULE_4__["CITIES"].includes(newCity)) {
